---
name: nw-researcher
description: Use for evidence-driven research with source verification. Gathers knowledge from
  web and files, cross-references across multiple sources, and produces cited research
  documents.
tools:
  - read
  - edit
